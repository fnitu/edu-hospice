...
export const GLOBALS = {
  DATA_URL: {
    ...
    USER_ALL_DETAILS: `${environment.BASE_URL}/api/users/current-user/full-details`,
    ...
    REORDER_SECTION: `${environment.BASE_URL}/api/admin/courses/{courseId}/sections/reorder`,
    ...
    REORDER_SECTION_CONTENT: `${environment.BASE_URL}/api/admin/courses/sections/{sectionId}/contents/reorder`,
